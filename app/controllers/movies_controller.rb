class MoviesController < ApplicationController
  ...
  def create
    ...
    if movie.save!
      ...
      redner status: :bad_request, json: { "errors": movie.errors.messages }
    end
  end
  ...
  def movie_params
    return params.require(:movie).permits(:title, :overview, :release_date, :inventory, :available_inventory)
  end
end
